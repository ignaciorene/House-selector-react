                ...
                <div className="second-container">
                    ...
                    <div className="options-container">
                        <div className="startButtons-container">
                            <button id='startButton' onClick={() => optionSelected('normalSelection')}>Normal selection</button>
                            <button id='startButton' onClick={() => optionSelected('allQuestionsSelection')}>All questions selection</button>
                        </div>
                    </div>
                </div>
                </>
